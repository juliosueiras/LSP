...
def apply_project_overrides(client_config: 'ClientConfig', window: 'sublime.Window') -> 'ClientConfig':
...
class WindowConfigManager(object):
    def __init__(self, window, global_configs: 'List[ClientConfig]') -> None:
        self._window = window
