...
from typing import Any, Optional, Sequence, Tuple, Union, List, Sized, Dict
...
def find_resources(pattern) -> Sequence[str]: ...
...
def set_timeout(f, timeout_ms: int = ...) -> None: ...
def set_timeout_async(f, timeout_ms: int = ...) -> None: ...
...
class Window:
    ...
    def find_open_file(self, fname: str) -> Any: ...
    ...
    def active_view_in_group(self, group: int) -> Any: ...
    ...
    def create_output_panel(self, name: str, unlisted: bool = ...) -> Any: ...
    def find_output_panel(self, name: str) -> Any: ...
    def destroy_output_panel(self, name: str) -> None: ...
    def active_panel(self) -> Optional[str]: ...
    def panels(self) -> List[str]: ...
    def get_output_panel(self, name: str): ...
    def show_input_panel(self, caption: str, initial_text: str, on_done, on_change, on_cancel) -> Any: ...
