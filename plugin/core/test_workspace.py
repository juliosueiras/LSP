...
from .test_windows import MockWindow
...
class WorkspaceTest(TestCase):
    ...
    def test_get_common_prefix_of_workspaces_for_window(self):
        window = MockWindow()
    ...
    def test_get_workspaces_from_window_single_file(self):
        window = MockWindow()
    ...
    def test_get_workspaces_from_window_single_window(self):
        window = MockWindow()
        window._project_file_name = None
